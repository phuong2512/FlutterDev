...
class PhotoGalleryScreen extends StatefulWidget {
  ...
  @override
  State<PhotoGalleryScreen> createState() => _PhotoGallaryScreenState();
}

class _PhotoGallaryScreenState extends State<PhotoGalleryScreen> {
  ...
  Future loadImages() async {
    final urls = <String>[];
    try {
      final results = await FirebaseStorage.instance.ref('images').listAll();
